import type { FileIndex, DirectoryNode } from './types';

const HIDDEN_DIRS = new Set(['node_modules', '.git', 'dist', '.next', 'build', '.cache', '__pycache__']);
const SOURCE_EXTS = new Set(['.ts', '.tsx', '.js', '.jsx', '.css', '.json', '.md', '.html', '.glsl', '.frag', '.vert']);
